...
export function VoiceSection() {
  ...
  function preview() {
    ...
    setPreviewing(true);
    speak(
      "This is how Aviel AI will sound when it reads a reply aloud.",
      values,
      voices,
      () => setPreviewing(false),
  ...
  return (
    <>
      <SectionHeader
        title="Voice"
        description="Speaking to Aviel, and hearing it read a reply back."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <Callout title="Where voice runs">
        ...
        the voices installed on this device. No audio is ever sent to a Aviel
      ...
      <SettingsCard title="Speaking to Aviel">
        <SettingsRow
      ...
      <SettingsCard title="Audio">
        <SettingsRow
          ...
          description="Requested when Aviel opens the microphone. Browser dictation does not accept audio constraints, so this applies to the microphone check below and to live voice."
        >
          <SettingsToggle
            label="Noise reduction"
