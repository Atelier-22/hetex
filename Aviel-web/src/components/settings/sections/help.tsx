...
const FAQS = [
  {
    q: "Why does Aviel not tell me which model it uses?",
  ...
  {
    q: "Can the Aviel team read my conversations?",
    ...
    <>
      ...
      <SettingsCard title="Help centre">
        <LinkRow
          ...
          href="/help"
        />
        <LinkRow label="Status" description="Whether Aviel is up." href="/status" />
        ...
        {diagnostics && (
          <SettingsBlock>
            ...
            <p className="mt-2.5 text-xs text-[var(--text-secondary)]">
              Aviel {diagnostics.version} ({diagnostics.build}) · Node{" "}
      ...
      <SettingsCard
        title="Get in touch"
        description="Reports are stored and reviewed by the Aviel team in the admin dashboard."
      >
        <SettingsRow
          ...
          <textarea
            ...
            placeholder={
              kind === "bug"
                ...
                : kind === "safety"
                  ? "What did Aviel say, and why was it harmful? Paste the reply if you can."
