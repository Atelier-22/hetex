...
function describeProviderError(err: unknown): string {
  ...
  if (err instanceof Anthropic.BadRequestError) {
    ...
    if (message.includes("usage limit") || message.includes("usage limits")) {
      return "This Aviel account has reached its AI usage limit. The account owner needs to raise the spending limit in the Anthropic console before chat will work again.";
    }
