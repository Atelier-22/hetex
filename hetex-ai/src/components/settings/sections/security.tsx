  ...
  return (
    <>
        ...
        <SettingsBlock>
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {pwError && (
                <span role="alert" className="text-xs text-hetex-red-500">
                  {pwError}
                </span>
              )}
            </div>
      ...
      >
        ...
        {enrolment && (
          <SettingsBlock
            label="Add Hetex to your authenticator app"
        ...
        {totpError && (
          <p role="alert" className="pb-3 text-xs text-hetex-red-500">
            {totpError}
          </p>
        )}
              ...
              return (
                ...
                >
                  ...
                  {!s.current && (
                    <button
                      onClick={() => revoke(s.id)}
                      className="focus-ring shrink-0 rounded-lg px-2 py-1 text-xs text-hetex-red-500 hover:bg-hetex-red-500/10"
                    >
                      Sign out
                    </button>
                  )}
      ...
      <Callout title="How sessions are revoked">
        ...
        handle to pull. Hetex records every issued token and checks it on each
