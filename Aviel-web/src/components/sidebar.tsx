...
const COLLAPSED_KEY = "Aviel.sidebar.collapsed";
// Read only when the conversation list cannot be fetched. See load(), below.
const CACHE_KEY = "Aviel.conversations.cache";
        ...
        {menuFor === c.id && (
          <div className="absolute right-1 top-full z-20 mt-1 w-40 overflow-hidden rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-secondary)] py-1 shadow-lg">
            ...
            <button
              ...
              className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-sm text-Aviel-red-500 hover:bg-Aviel-red-500/10"
            >
  ...
  const content = (
    ...
    >
      <div className="flex items-center justify-between px-3 py-4">
        ...
        {collapsed && (
          <Link href="/chat" className="mx-auto" aria-label="Aviel AI — new chat">
            <AvielIcon size={28} priority />
          </Link>
        )}
        <button
        ...
        {accountOpen && !collapsed && (
          <div className="absolute bottom-full left-2 right-2 z-30 mb-1 overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-secondary)] py-1 shadow-lg">
            ...
            <button
              ...
              className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-Aviel-red-500 hover:bg-Aviel-red-500/10"
            >
