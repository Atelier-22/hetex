...
export function ModelsSection() {
  ...
  return (
    <>
      <SectionHeader
        title="AI & models"
        description="Which model answers you, where it runs, and when Hetex chooses for you."
        onReset={reset}
        resetting={resetting}
      />
            ...
            <div className="flex min-w-0 gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs leading-relaxed text-[var(--text-secondary)]">
                  {p.local
                    ? "Runs on the Hetex server. No API key, and nothing leaves the machine."
      ...
      <SettingsCard
        ...
        description="Hetex classifies each message and sends it to the model you have assigned to that kind of work. Anything it cannot classify uses your default."
      >
        <SettingsRow
      ...
      <SettingsCard title="How models are used">
        <SettingsRow
          label="Let Hetex search the web"
          icon={Globe}
