...
export function SafetySection() {
  ...
  return (
    <>
      <SectionHeader
        title="Safety"
        description="What Hetex will not help with, and how it says so."
        onReset={reset}
        resetting={resetting}
      />
      ...
      >
        ...
        <SettingsRow
          ...
          icon={ShieldAlert}
          description="Offers emergency services and a crisis line when someone may be in danger. Turning this off stops the resource list appearing in routine messages — it does not stop Hetex naming emergency services when there is immediate danger to life, which is not optional."
        >
          <SettingsToggle
            label="Include crisis resources"
      ...
      <SettingsCard title="Reporting">
        <SettingsRow
          ...
          description="If Hetex said something harmful, tell us. Reports are stored and reviewed."
        >
          <button
            type="button"
