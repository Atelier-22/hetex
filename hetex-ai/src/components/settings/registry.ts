...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    description: "How Hetex sounds when it talks to you.",
    icon: Sparkles,
    group: "personality",
    entries: [
      "personality",
  ...
  },
  {
    ...
    category: "ai",
    label: "AI behavior",
    description: "What Hetex does when it answers.",
    icon: Braces,
    group: "behavior",
    entries: [
      "follow-up questions",
  ...
  },
  {
    ...
    category: "ai",
    label: "Memory",
    description: "What Hetex remembers between conversations.",
    icon: Brain,
    group: "memory",
    entries: [
      "memory",
  ...
  },
  {
    ...
    category: "media",
    label: "Voice",
    description: "Speaking to Hetex, and hearing it back.",
    icon: Mic,
    group: "voice",
    entries: [
      "voice",
  ...
  },
  {
    ...
    category: "app",
    label: "Language",
    description: "What language Hetex reads and replies in.",
    icon: Languages,
    group: "language",
    entries: [
      "language",
  ...
  },
  {
    ...
    category: "workspace",
    label: "Integrations",
    description: "Services Hetex can connect to.",
    icon: Blocks,
    entries: [
      "integrations",
      "plugins",
