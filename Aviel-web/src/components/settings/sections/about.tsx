...
/**
 * The open-source packages Aviel is built on, and their licences.
 *
...
export function AboutSection() {
  ...
  return (
    <>
      <SectionHeader title="About Aviel AI" description="What is running, and what it is built on." />

      <div className="settings-card mb-4 flex items-center gap-4 p-5">
        <AvielIcon size={52} />
        <div className="min-w-0">
          <p className="text-lg font-semibold">Aviel AI</p>
      ...
      <SettingsCard
        title="Open source"
        description="Aviel AI is built on the work of others. These are the direct dependencies that ship in the product."
      >
        {LICENSES.map((l) => (
      ...
      <p className="mt-4 text-center text-xs leading-relaxed text-[var(--text-secondary)]">
        Aviel AI was created by Muhwezi Peter, its founder, in Kampala, Uganda,
