...
export const metadata: Metadata = {
  title: "Status — Aviel AI",
  description: "Live status of the Aviel AI service.",
};
  ...
  return (
    ...
    >
      <div
        className={`mb-6 flex items-center gap-3 rounded-xl border px-4 py-3.5 ${
          allUp
            ...
            : "border-aviel-red-500/30 bg-aviel-red-500/10"
        }`}
      >
        <span
          className={`h-2.5 w-2.5 shrink-0 rounded-full ${
            allUp ? "bg-accent" : "bg-aviel-red-500"
          }`}
        />
          ...
          >
            ...
            <span
              className={`shrink-0 text-xs font-medium ${
                s.up ? "text-accent" : "text-aviel-red-500"
              }`}
            >
      ...
      <p className="mt-6 text-xs leading-relaxed text-[var(--text-secondary)]">
        Aviel runs on a free hosting tier, which sleeps after a period of
