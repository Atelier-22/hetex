...
The backend for Hetex AI. Express + TypeScript + PostgreSQL, deployed on Render.
...
Hetex started as a single Next.js app where the API routes and the UI shipped
