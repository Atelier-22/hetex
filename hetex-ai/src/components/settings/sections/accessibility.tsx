    ...
    <>
      ...
      <SettingsCard title="Contrast and motion">
        ...
        <SettingsRow
          ...
          unavailable={
            systemReducedMotion
              ? "Your system already asks for reduced motion, and Hetex honours that regardless of this switch."
              : undefined
          }
        >
      ...
      <SettingsCard title="Navigation and input">
        <SettingsRow
          ...
          icon={Keyboard}
          description="Every control in Hetex is reachable by Tab and operable by Enter or Space, and shows a visible focus ring. This is not optional and cannot be turned off."
        >
        ...
        <SettingsRow
          label="Captions"
          unavailable="Hetex plays no audio or video other than reading a reply aloud, and that reply is already on screen as text. There is nothing to caption."
        >
