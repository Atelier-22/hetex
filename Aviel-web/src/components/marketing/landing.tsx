...
const FEATURES = [
  ...
  },
  {
    ...
    body: "When an answer depends on something current, Aviel searches the web itself and shows you the pages it read, so you can check the source rather than take its word.",
  },
  {
    icon: Brain,
    title: "It learns how you work",
    body: "Turn memory on and Aviel notes what matters — the language you write in, the answers you find useful — so you stop explaining yourself every time.",
  },
  {
    icon: FolderKanban,
    title: "Projects",
      ...
      <section className="relative overflow-hidden px-5 pb-20 pt-16 sm:pt-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-[var(--text-secondary)] sm:mt-5 sm:text-lg">
            AI should empower people, not replace them — so Aviel AI is a
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
            <PillLink href="/register">Talk with Aviel AI</PillLink>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "When an answer depends on current information, Aviel searches the web itself and shows you the pages it read.",
              },
              {
                step: "03",
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 text-[15px] leading-relaxed text-[var(--text-secondary)]">
                We do not train on what you write — Aviel does not train models
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 flex flex-col gap-3">
            {[
              {
                q: "What does it cost?",
                a: "Nothing. Aviel is free while in early access, and there are no paid plans yet.",
              },
              {
      ...
      >
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-6 space-y-5 text-[15px] leading-relaxed text-[var(--text-secondary)]">
            <p>
              Aviel AI started as a vision in 2025 — an idea for what an AI
