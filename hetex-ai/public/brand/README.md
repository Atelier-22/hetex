...
| File | Used by | Notes |
| --- | --- | --- |
| `hetex-logo-color.png` | Empty-chat screen (80px), collapsed sidebar (28px) | Icon only, square, transparent. 512×512 or larger |
| `hetex-lockup-light.png` | Sidebar header and auth pages **in light theme** | Icon + wordmark, **dark text**, transparent |
| `hetex-lockup-dark.png` | Sidebar header and auth pages **in dark theme** | Icon + wordmark, **white text**, transparent |
...
Nothing renders broken: the lockup falls back to the text "Hetex AI" and the
