 ...
 *    Aviel account. This is the simple path: set two environment variables and
 ...
 *
 * 2. ADMIN_EMAILS — existing Aviel accounts promoted to admin, for when more
...
export const requireAdmin: RequestHandler = (req, res, next) => {
  ...
  // Path 2: a Aviel account that is an admin.
  db.query.users
    .findFirst({
