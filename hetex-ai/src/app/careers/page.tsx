...
export const metadata: Metadata = {
  title: "Careers — Hetex AI",
  description: "Hetex AI is a two-person team and is not hiring yet.",
};
...
export default function CareersPage() {
  return (
    ...
    >
      <Prose>
        <p>
          Hetex AI is two people — Muhwezi Peter, who builds it, and Alafi
        ...
        <p>
          Hetex is open source. The most direct way in is to use it, find
          something wrong, and{" "}
          <a
