    ...
    <div className="h-full overflow-y-auto px-6 py-10 md:px-12">
      <div className="mx-auto max-w-2xl text-sm leading-relaxed text-[var(--text-secondary)]">
        <h1 className="text-2xl font-semibold text-[var(--text-primary)]">
          Aviel AI — Terms and Conditions
        </h1>
        <p className="mt-2 text-xs">Last Updated: August 10, 2026</p>

        <p className="mt-6">
          Welcome to <strong>Aviel AI</strong>. These Terms and Conditions
          ("Terms") govern your access to and use of Aviel AI, including our
          website, applications, AI models, APIs, tools, features, and
          related services (collectively, the "Service").
        </p>
        <p className="mt-4">
          By creating an account, accessing, or using Aviel AI, you agree to
          these Terms. If you do not agree with these Terms, you must not use
          the Service.
        </p>

        <Section title="1. About Aviel AI">
          <p>
            Aviel AI is an artificial intelligence platform designed to help
          ...
          <p className="mt-2">
            Aviel AI may use artificial intelligence models and third-party
        ...
        <Section title="2. Eligibility">
          ...
          <p className="mt-2">
            ...
            to use an AI service independently, you may only use Aviel AI
            with appropriate parental or guardian involvement where required
            by applicable law.
          </p>
          <p className="mt-2">
            You are responsible for ensuring that your use of Aviel AI
            complies with the laws applicable to you.
          </p>
        </Section>

        <Section title="3. Your Aviel AI Account">
          ...
          <List
            items={[
              ...
              "Immediately notify Aviel AI if you believe your account has been compromised.",
              "Accept responsibility for activity occurring through your account unless caused by a security failure attributable to Aviel AI.",
            ]}
          />
          <p className="mt-2">
        ...
        <Section title="4. Using Aviel AI">
          <p>
            You may use Aviel AI only for lawful purposes and in accordance
            with these Terms.
          </p>
          <p className="mt-2">You must not use Aviel AI to:</p>
          <List
            items={[
              ...
              "Interfere with or disrupt Aviel AI's infrastructure.",
              "Reverse engineer, decompile, or attempt to extract proprietary components of Aviel AI except where permitted by applicable law.",
              "Use automated systems to abuse, overload, scrape, or excessively access the Service.",
              "Use Aviel AI to create or distribute content that violates applicable law.",
            ]}
          />
          <p className="mt-2">
            Aviel AI may restrict or refuse requests that present significant
        ...
        <Section title="5. AI-Generated Information">
          <p>
            Aviel AI uses artificial intelligence and does not guarantee that
          ...
          <p className="mt-2 font-medium text-[var(--text-primary)]">
            Do not rely solely on Aviel AI for medical, legal, financial,
        ...
        <Section title="6. Important Decisions">
          <p>
            Aviel AI is intended to assist users, not replace professional
            judgment.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            For example, Aviel AI should not be treated as a substitute for:
          </p>
          <List
            items={[
        ...
        <Section title="7. User Content">
          <p>
            ...
            other information to Aviel AI ("User Content").
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            rights and permissions to submit User Content to Aviel AI.
          </p>
          <p className="mt-2">
        ...
        <Section title="8. Use of User Content">
          <p>To provide the Service, Aviel AI may need to process User Content.</p>
          <p className="mt-2">
            Depending on the features you use, your content may be processed
            by Aviel AI's infrastructure and by third-party technology
            providers that help operate the Service.
          </p>
          <p className="mt-2">
            Aviel AI will handle personal information according to its
            Privacy Policy.
          </p>
          <p className="mt-2">
            Users should avoid submitting highly sensitive information unless
            the relevant Aviel AI feature specifically supports such
            information.
          </p>
        </Section>
        ...
        <Section title="9. Privacy">
          ...
          />
          <p className="mt-2">
            The Privacy Policy forms part of your relationship with Aviel AI.
          </p>
        </Section>

        <Section title="10. Intellectual Property">
          <p>
            The Aviel AI name, logo, website, software, interface, branding,
            underlying technology, and other proprietary components of the
            Service are owned by Aviel AI or its licensors unless otherwise
            stated.
          </p>
          <p className="mt-2">
            You may not copy, reproduce, distribute, modify, sell, or
            commercially exploit Aviel AI's proprietary materials without
            authorization.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            However, because AI-generated content may not be unique, Aviel AI
        ...
        <Section title="11. Third-Party Services">
          <p>
            Aviel AI may integrate with or rely on third-party services,
          ...
          <p className="mt-2">
            Aviel AI is not responsible for independent third-party services
            outside its control.
          </p>
        </Section>
        ...
        <Section title="12. External Information and Links">
          <p>
            Aviel AI may provide information obtained from external sources
        ...
        <Section title="13. Subscriptions and Payments">
          <p>
            Some Aviel AI features may be provided free of charge while
          ...
          <p className="mt-2">
            You authorize Aviel AI or its payment provider to charge the
        ...
        <Section title="14. Refunds">
          ...
          <p className="mt-2">
            Where a refund policy applies, Aviel AI will communicate the
        ...
        <Section title="15. Service Availability">
          <p>
            We aim to keep Aviel AI available and reliable, but we do not
          ...
          />
          <p className="mt-2">
            We may modify, suspend, or discontinue features of Aviel AI when
            reasonably necessary.
          </p>
        </Section>

        <Section title="16. Usage Limits">
          <p>Aviel AI may impose limits on:</p>
          <List
            items={[
              "Messages.",
              "AI generations.",
        ...
        <Section title="17. Security">
          ...
          <p className="mt-2">
            You must not attempt to compromise Aviel AI's security or assist
            another person in doing so.
          </p>
        </Section>

        <Section title="18. Prohibited Technical Activities">
          <p>You must not use Aviel AI or its infrastructure to:</p>
          <List
            items={[
              ...
              "Exploit Aviel AI vulnerabilities for malicious purposes.",
              "Abuse APIs or automated endpoints.",
              "Attempt unauthorized access to another user's account or data.",
              "Probe or attack Aviel AI infrastructure outside an authorized security-testing program.",
            ]}
          />
          <p className="mt-2">
            Security researchers who discover vulnerabilities should use
            Aviel AI's designated security-reporting channel where one is
            available.
          </p>
        </Section>
        ...
        <Section title="19. Account Suspension and Termination">
          <p>
            Aviel AI may suspend or terminate an account if we reasonably
          ...
          <List
            items={[
              ...
              "Used the Service in a manner that could harm Aviel AI, its users, or third parties.",
            ]}
          />
          <p className="mt-2">
          ...
          <p className="mt-2">You may stop using Aviel AI at any time.</p>
        </Section>

        <Section title="20. Changes to Aviel AI">
          <p>We may modify, update, add, or remove features from Aviel AI.</p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            Your continued use of Aviel AI after updated Terms become
        ...
        <Section title="21. Disclaimer of Warranties">
          <p>
            To the maximum extent permitted by applicable law, Aviel AI is
        ...
        <Section title="22. Limitation of Liability">
          <p>
            To the maximum extent permitted by applicable law, Aviel AI and
        ...
        <Section title="23. Indemnification">
          <p>
            ...
            and hold harmless Aviel AI and its affiliates, employees,
        ...
        <Section title="24. Governing Law">
          <p>
            These Terms will be governed by the laws applicable to Aviel AI
          ...
          <p className="mt-2">
            ...
            process applicable to the user's jurisdiction and the Aviel AI
            operating entity.
          </p>
        </Section>
        ...
        <Section title="25. Contact">
          <p>
            ...
            matters, security concerns, or the Service, you may contact Aviel
        ...
        <Section title="26. Acceptance">
          <p>By accessing or using Aviel AI, you acknowledge that:</p>
          <List
            items={[
              "You have read these Terms.",
              "You understand these Terms.",
              "You agree to be bound by these Terms.",
              "You will use Aviel AI responsibly and lawfully.",
            ]}
          />
          <p className="mt-2">
            If you do not agree with these Terms, you must stop using Aviel
            AI.
          </p>
        </Section>

        <p className="mt-8 text-xs">© 2026 Aviel AI. All rights reserved.</p>
      </div>
    </div>
  );
}
