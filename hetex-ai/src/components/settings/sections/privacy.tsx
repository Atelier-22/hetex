  ...
  return (
    <>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-[var(--text-secondary)]">
              {processedLocally
                ? "Your messages are answered by a model running on the Hetex server itself. Nothing is sent to an external AI provider."
      ...
      <SettingsCard title="What is kept">
        ...
        <SettingsRow
          label="Memory"
          description="What Hetex remembers about you, and how to see or delete it."
        >
        ...
        <SettingsRow
          ...
          unavailable="Hetex never records audio. Speech recognition runs in your browser and produces text; the audio is never uploaded and there is nowhere to store it."
        >
        ...
        <SettingsBlock>
          <div className="flex flex-wrap gap-2">
            <SettingsButton
              busy={busy === "all"}
              onClick={() =>
                download("/account/export", `hetex-export-${stamp}.json`, "all")
              }
            >
      ...
      {actionError && (
        <p role="alert" className="mt-4 text-xs text-hetex-red-500">
          {actionError}
        </p>
      )}

      <Callout title="What Hetex never does">
        Your conversations are not read by the Hetex team. The admin dashboard
