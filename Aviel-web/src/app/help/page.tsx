...
export const metadata: Metadata = {
  title: "Help — Aviel AI",
  description: "How Aviel AI works, and answers to common questions.",
};

/** Every answer describes behaviour that exists in the product today. */
const FAQ = [
  {
    q: "Can Aviel search the web?",
  ...
  },
  {
    ...
    a: "Only if you turn Memory on, in Settings → Personalization. It is off by default. With it on, Aviel notes durable things about you — how you like answers, what you are working on — and you can read and delete every entry. Turning it off stops it both reading and adding.",
  },
  {
...
export default function HelpPage() {
  return (
    <MarketingPage
      title="Help"
      intro="How Aviel AI works today. If something here does not match what you see, that is a bug — please tell us."
    >
