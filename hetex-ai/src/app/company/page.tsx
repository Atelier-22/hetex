...
export const metadata: Metadata = {
  title: "Company — Hetex AI",
  description: "Hetex AI is built in Kampala, Uganda by Muhwezi Peter.",
};
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <main className="mx-auto max-w-2xl px-5 py-16">
        ...
        <div className="mt-7 space-y-5 text-[15px] leading-relaxed text-[var(--text-secondary)]">
          <p>
            Hetex AI started as a vision in 2025 — an idea for what an AI company
