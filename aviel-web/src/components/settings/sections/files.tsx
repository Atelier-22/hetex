    ...
    <>
      ...
      <SettingsCard title="Where files are stored">
        <SettingsRow
          ...
          icon={Database}
          description="Attachments are held in the Aviel database as data URLs. There is no object store and no persistent disk on the hosting used here, so this is the only backend that exists."
        >
