  ...
  return (
    <>
      <SectionHeader
        ...
        description="Who you are, how Aviel addresses you, and how you sign in."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <SettingsCard title="Identity">
        ...
        <SettingsRow
          label="Display name"
          description="What Aviel calls you, and what appears in the sidebar."
        >
          <TextField
            label="Display name"
            className="w-56"
        ...
        <SettingsRow
          label="Username"
          icon={AtSign}
          description="Unique across Aviel. Leave it blank if you would rather not have one."
        >
          <TextField
            label="Username"
            className="w-56"
      ...
      <SettingsCard
        ...
        description="Everything here is added to what Aviel knows about you, and it uses it when replying."
      >
        <SettingsRow
