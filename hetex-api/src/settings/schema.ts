// Hetex AI — canonical user settings schema.
//
...
export const personalitySchema = z.object({
  ...
  assistantName: z.string().min(1).max(80).default("Hetex AI"),
...
export const liveVoiceSchema = z.object({
  ...
  /** Talking over Hetex stops it speaking. */
  allowInterrupt: z.boolean().default(true),
  /** Hetex may start replying before you have stopped speaking. */
