  ...
  return (
    <>
      <SectionHeader
        ...
        description="How Aviel sounds. Every choice here goes into the system prompt for your next message — existing conversations included."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <SettingsCard title="Voice and register">
        ...
        <SettingsRow
          ...
          description="What Aviel calls itself in a reply."
        >
          <TextField
            label="Assistant name"
            className="w-48"
