...
export const metadata: Metadata = {
  title: "Changelog — Hetex AI",
  description: "What has shipped in Hetex AI.",
};
...
const ENTRIES = [
  {
    ...
    items: [
      "Hetex can search the web and cites the pages it used. It searches on its own when an answer depends on current information.",
      "Memory now learns. With it switched on, Hetex notes durable things about you from your conversations instead of waiting for you to write a list. Every entry is visible and deletable.",
  ...
  },
  {
    version: "Foundations",
    items: [
      "Hetex went live: web app on Vercel, API and Postgres on Render.",
  ...
  return (
    ...
    >
      ...
      <p className="mt-10 text-xs text-[var(--text-secondary)]">
        Hetex is open source — the full commit history is on{" "}
        <a
          href="https://github.com/Atelier-22/hetex/commits/main"
          target="_blank"
