...
export function LanguageSection() {
  ...
  return (
    <>
      <SectionHeader
        title="Language"
        description="What language Hetex reads, replies in, and speaks."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <SettingsCard title="Replies">
        ...
        <SettingsRow
          ...
          description="On 'Match my message', Hetex replies in whatever language your message was written in."
        >
          <SettingsToggle
            label="Match the language I write in"
        ...
        <SettingsRow
          ...
          unavailable={
            translationsAvailable
              ? undefined
              : "Hetex has no translations yet, so the interface is English. Your choice is stored and will apply when translations ship — nothing here claims a language the app cannot actually display."
          }
        >
