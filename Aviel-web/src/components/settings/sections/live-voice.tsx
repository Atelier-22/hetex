    ...
    <>
      ...
      <SettingsCard title="Interruption">
        <SettingsRow
          ...
          description="Speaking while Aviel is talking stops it and starts listening to you."
        >
          <SettingsToggle
            label="Let me interrupt"
      ...
      <SettingsCard title="Transcript and audio">
        ...
        <SettingsRow
          ...
          unavailable="Aviel has no audio store, so recordings cannot be kept. Nothing you say is recorded or uploaded — the microphone feeds your browser's speech recognition and nothing else."
        >
