...
export const metadata: Metadata = {
  title: "Privacy — Aviel AI",
  description: "What Aviel AI stores, why, and how to remove it.",
};
      ...
      <Prose>
        ...
        <ul className="ml-5 list-disc space-y-1.5">
          <li>
            ...
            Aviel does not train models at all.
          </li>
        ...
        <p>
          Aviel runs on Render (application and database) and Vercel (the
        ...
        <p>
          Aviel is an early-stage product built by a small team. It has not had
        ...
        <H2>Children</H2>
        <p>
          Aviel AI is not intended for children under 13, and accounts should
