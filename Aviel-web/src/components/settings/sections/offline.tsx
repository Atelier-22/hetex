...
export function OfflineSection() {
  ...
  // How much this browser is storing for Aviel, and what it is allowed.
  useEffect(() => {
  ...
  return (
    <>
      <SectionHeader
        ...
        description="What runs on the Aviel server itself, and what this browser keeps when there is no connection."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <Callout title="What offline really means here">
        Aviel is a web app, so an offline session can read what this browser has
        cached but cannot send a message — the model runs on the server, not in
        your browser. &ldquo;Local AI&rdquo; means the model runs on the Aviel
