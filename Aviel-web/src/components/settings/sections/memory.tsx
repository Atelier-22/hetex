...
export function MemorySection() {
  ...
  return (
    <>
      <SectionHeader
        title="Memory"
        description="What Aviel carries between conversations. Nothing is remembered while this is off, and nothing is recalled from a category you have switched off."
        onReset={reset}
        resetting={resetting}
      />
      ...
      <SettingsCard title="Memory">
        ...
        <SettingsRow
          ...
          description="Off means Aviel only remembers what you add here by hand. It never infers anything on its own."
        >
          <SettingsToggle
            label="Add to memory automatically"
      ...
      <SettingsCard
        ...
        description="Everything Aviel has stored about you. Edit or delete any of it."
      >
        <SettingsBlock>
          ...
          {memoryError && (
            <p role="alert" className="mt-2 text-xs text-Aviel-red-500">
              {memoryError}
            </p>
          )}
        </SettingsBlock>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex shrink-0 gap-0.5">
                        ...
                        <button
                          ...
                          className="focus-ring rounded p-1.5 text-[var(--text-secondary)] hover:text-Aviel-red-500"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
